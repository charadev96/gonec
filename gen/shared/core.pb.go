...
func (x *ServerIdentity) Reset() {
	*x = ServerIdentity{}
	mi := &file_shared_core_proto_msgTypes[0]
...
func (*ServerIdentity) Descriptor() ([]byte, []int) {
	return file_shared_core_proto_rawDescGZIP(), []int{0}
}
...
func (x *InviteCredential) Reset() {
	*x = InviteCredential{}
	mi := &file_shared_core_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InviteCredential) Descriptor() ([]byte, []int) {
	return file_shared_core_proto_rawDescGZIP(), []int{1}
}
...
func (x *InviteTicket) Reset() {
	*x = InviteTicket{}
	mi := &file_shared_core_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*InviteTicket) Descriptor() ([]byte, []int) {
	return file_shared_core_proto_rawDescGZIP(), []int{2}
}
...
func (x *Session) Reset() {
	*x = Session{}
	mi := &file_shared_core_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Session) Descriptor() ([]byte, []int) {
	return file_shared_core_proto_rawDescGZIP(), []int{3}
}
...
var File_shared_core_proto protoreflect.FileDescriptor

const file_shared_core_proto_rawDesc = "" +
	"\n" +
	"\x11shared/core.proto\x12\x0fgonec.shared.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"N\n" +
...
var (
	file_shared_core_proto_rawDescOnce sync.Once
	file_shared_core_proto_rawDescData []byte
)

func file_shared_core_proto_rawDescGZIP() []byte {
	file_shared_core_proto_rawDescOnce.Do(func() {
		file_shared_core_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_shared_core_proto_rawDesc), len(file_shared_core_proto_rawDesc)))
	})
	return file_shared_core_proto_rawDescData
}

var file_shared_core_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_shared_core_proto_goTypes = []any{
...
var file_shared_core_proto_depIdxs = []int32{
...
func init() { file_shared_core_proto_init() }
func file_shared_core_proto_init() {
	if File_shared_core_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_shared_core_proto_rawDesc), len(file_shared_core_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_shared_core_proto_goTypes,
		DependencyIndexes: file_shared_core_proto_depIdxs,
		MessageInfos:      file_shared_core_proto_msgTypes,
	}.Build()
	File_shared_core_proto = out.File
	file_shared_core_proto_goTypes = nil
	file_shared_core_proto_depIdxs = nil
}
